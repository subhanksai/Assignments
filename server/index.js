...
const RuleModel = require("../server/models/Rule");
...
mongoose
  .connect(
    "mongodb+srv://admin:admin@backend.3fn3q.mongodb.net/AST?retryWrites=true&w=majority&appName=BackEnd"
  )
  .then(() => {
...
app.post("/create", async (req, res) => {
  ...
  try {
    ...
    const RuleData = new RuleModel({
      ruleId: ruleId,
      ruleString: ruleString,
      ast: rule, // This should be the parsed AST of the rule
    });
    try {
      await RuleData.save();
